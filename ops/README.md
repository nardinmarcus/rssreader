...
Selected periodicals remain production-off until the complete shadow release gate passes. Use [periodicals-shadow-verification.md](periodicals-shadow-verification.md); it forbids production `on` and production SQLite mutation.
