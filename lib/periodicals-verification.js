...
function contentHashRevisionDocument(document) {
  if (document.issue.cadence !== 'daily' || document.issue.status !== 'finalizing') {
    return document;
  }
  return {
    ...document,
...
function verifyEvidenceProvenance(db) {
  ...
  for (const issue of issueRows) {
    try {
      ...
      if (computePeriodicalContentHash(contentHashRevisionDocument(document)) !== issue.content_hash) {
