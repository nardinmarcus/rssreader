...
// Canonical AST text-segment walk owned by the document module; the
// translation pipeline, jobs, renderer and reading seam all share it.
...
function compileHtml(html, finalUrl) {
  ...
  const segments = articleDocumentSegments(ast);
  return {
    ast,
