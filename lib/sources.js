...
const SOURCE_LABEL_GROUPS = {
  '官方': new Set(['openai', 'anthropic', 'anthropic-research', 'google-deepmind', 'google-ai', 'huggingface-blog', 'meta-ai']),
  '研究': new Set(['anthropic-research', 'importai', 'nlp-elvis', 'interconnects', 'kexuefm', 'chinai', 'simonwillison', 'garymarcus', 'gwern', 'huggingface', 'the-batch', 'cognitiverevolution']),
  '产品': new Set(['bensbites', 'tldrai', 'whytryai', 'superhuman_ai', 'aibreakfast', 'theresanaiforthat', 'producthunt', 'github_trending', 'bestblogs', 'therundown', 'theneuron', 'memia', 'ai2roi']),
  '产业': new Set(['openai', 'anthropic', 'google-ai', 'chinai', 'ds-ai-section', 'kdnuggets-ai', 'aileadershipedge', 'natesnewsletter', 'aichangeseverything', 'lolitataub']),
  '社区': new Set(['hackernews', 'reddit_ai', 'user-submitted', 'lexfridman', 'latentspace', 'dwarkesh', 'hours80k']),
  '创作': new Set(['james-clear', 'waitbutwhy', 'brainfood', 'austinkleon', 'paulgraham', 'oneusefulthing', 'scotthyoung', 'readwise-wise', 'dankoe', 'experimental-history', 'construction-physics', 'shewritesai', 'hackernoon-writing']),
