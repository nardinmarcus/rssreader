...
const REFRESH_POLICIES = {
  hackernews: { refreshIntervalMs: 3 * HOUR_MS, refreshPriority: 5, refreshCost: 3 },
...
const SOURCES = [
  ...
  { id: 'openrouter', name: 'OpenRouter Blog', category: 'article', siteUrl: 'https://openrouter.ai/blog', enabled: true, limit: 15,
    feeds: ['https://openrouter.ai/blog/feed.xml'], description: 'OpenRouter 官方模型路由、API 工程、产品发布与行业洞察' },
...
const SOURCE_LABEL_GROUPS = {
  '官方': new Set(['openai', 'anthropic', 'anthropic-research', 'claude-blog', 'langchain-blog', 'openrouter', 'thinking-machines', 'google-deepmind', 'google-ai', 'google-research', 'huggingface-blog', 'meta-ai']),
  ...
  '产品': new Set(['openrouter', 'bensbites', 'aihot-daily', 'tldrai', 'whytryai', 'superhuman_ai', 'aibreakfast', 'theresanaiforthat', 'producthunt', 'github_trending', 'bestblogs', 'therundown', 'theneuron', 'memia', 'ai2roi']),
