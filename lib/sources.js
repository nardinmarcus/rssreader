...
const SOURCE_LABEL_GROUPS = {
  '官方': new Set(['openai', 'anthropic', 'google-deepmind', 'google-ai', 'huggingface-blog', 'meta-ai']),
  '研究': new Set(['importai', 'nlp-elvis', 'interconnects', 'kexuefm', 'chinai', 'simonwillison', 'garymarcus', 'gwern', 'huggingface', 'the-batch', 'cognitiverevolution']),
